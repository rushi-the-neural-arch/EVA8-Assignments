...
class Transformer(nn.Module):
  def __init__(self):
    ...
    self.conv1 = nn.Conv2d(3, 16, 5, bias=False)      # Output - 16x32x32
    self.bn1 = nn.BatchNorm2d(16)
    self.conv2 = nn.Conv2d(16, 32, 5, bias=False)      # Output - 32x32x32
    self.bn2 = nn.BatchNorm2d(32)
    self.conv3 = nn.Conv2d(32, 48, 5, bias=False)      # Output - 48x32x32

    self.gap = nn.AvgPool2d(20)            # Output - 48x1x1
